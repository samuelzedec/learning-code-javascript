...
(()=>{
    var e = {
                        ...
                        case "root":
                            {
                                ...
                                i = e.nodes.map((n)=>{
                                    ...
                                    if (typeof r === "undefined") {
                                        ...
                                        throw new Error('Inconsistent rule global/local result in rule "' + e + '" (multiple selectors must result in the same mode for the rule)');
                                    }
                                    if (!i.hasLocals) {
                        ...
                        case "pseudo":
                            {
                                ...
                                if (a) {
                                    ...
                                    if (o) {
                                        ...
                                        if (t.inside) {
                                            throw new Error(`A ${e.value} is not allowed inside of a ${t.inside}(...)`);
                                        }
                                        r = {
                                        ...
                                        i = e.map((e)=>transform(e, r)).reduce((e, t)=>e.concat(t.nodes), []);
                                        if (i.length) {
                            ...
                            Once (i) {
                                ...
                                i.walkAtRules((i)=>{
                                    if (/keyframes$/i.test(i.name)) {
                                        ...
                                        i.params = i.params.split("to").map((r)=>{
        ...
        305: (e, t, r)=>{
            ...
            var w = (S = {}, S[g.space] = true, S[g.cr] = true, S[g.feed] = true, S[g.newline] = true, S[g.tab] = true, S);
            ...
            var k = function() {
                ...
                e.attribute = function attribute() {
                    ...
                    this.position++;
                    while(this.position < this.tokens.length && this.currToken[_.FIELDS.TYPE] !== g.closeSquare){
                        ...
                        switch(c[_.FIELDS.TYPE]){
                            case g.space:
                                ...
                                if (a) {
                                    ...
                                    var d = (0, b.getProp)(n, "raws", "spaces", a, "after") || null;
                                    if (d) {
                            ...
                            case g.combinator:
                                ...
                                break;
                            case g.word:
                                if (p && this.content(p) === "|" && e[i + 2] && e[i + 2][_.FIELDS.TYPE] !== g.equals && !n.operator && !n.namespace) {
                                    n.namespace = l;
                                    a = "namespace";
                            ...
                            case g.str:
                                ...
                                var O = (0, f.unescapeValue)(l), P = O.unescaped, E = O.quoteMark;
                                n.value = P;
                                n.quoteMark = E;
                                a = "value";
                                (0, b.ensureObject)(n, "raws");
                            ...
                            case g.comment:
                                if (a) {
                                    if (u || p && p[_.FIELDS.TYPE] === g.space || a === "insensitive") {
                ...
                e.isNamedCombinator = function isNamedCombinator(e) {
                    ...
                    return this.tokens[e + 0] && this.tokens[e + 0][_.FIELDS.TYPE] === g.slash && this.tokens[e + 1] && this.tokens[e + 1][_.FIELDS.TYPE] === g.word && this.tokens[e + 2] && this.tokens[e + 2][_.FIELDS.TYPE] === g.slash;
                };
                ...
                e.combinator = function combinator() {
                    ...
                    if (this.isNamedCombinator()) {
                        ...
                        this.position++;
                    } else if (w[this.currToken[_.FIELDS.TYPE]]) {} else if (!u) {
                        this.unexpected();
                    }
                    if (c) {
                        if (u) {
                        ...
                        var d = this.convertWhitespaceNodesToSpace(u, true), v = d.space, y = d.rawSpace;
                        if (!y) {
                            y = v;
                        }
                        var b = {};
                ...
                e.pseudo = function pseudo() {
                    ...
                    if (this.currToken[_.FIELDS.TYPE] === g.word) {
                        this.splitWord(false, function(n, i) {
                            ...
                            if (i > 1 && e.nextToken && e.nextToken[_.FIELDS.TYPE] === g.openParenthesis) {
                ...
                e.space = function space() {
                    var e = this.content();
                    if (this.position === 0 || this.prevToken[_.FIELDS.TYPE] === g.comma || this.prevToken[_.FIELDS.TYPE] === g.openParenthesis || this.current.nodes.every(function(e) {
                        return e.type === "comment";
                    })) {
                        this.spaces = this.optionalSpace(e);
                        this.position++;
                    } else if (this.position === this.tokens.length - 1 || this.nextToken[_.FIELDS.TYPE] === g.comma || this.nextToken[_.FIELDS.TYPE] === g.closeParenthesis) {
        ...
        45: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/postcss-value-parser/index.js [app-rsc] (ecmascript)");
        },
        837: (e)=>{
            "use strict";
...
//# sourceMappingURL=node_modules_next_dist_compiled_postcss-modules-local-by-default_index_64666d.js.map