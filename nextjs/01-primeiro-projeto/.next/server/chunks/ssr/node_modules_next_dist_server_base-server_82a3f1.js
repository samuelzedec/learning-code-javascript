...
const _utils2 = __turbopack_require__("[project]/node_modules/next/dist/server/utils.js [app-rsc] (ecmascript)");
...
const _localeroutenormalizer = __turbopack_require__("[project]/node_modules/next/dist/server/normalizers/locale-route-normalizer.js [app-rsc] (ecmascript)");
...
const _apppageroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/app-page-route-matcher-provider.js [app-rsc] (ecmascript)");
const _approuteroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/app-route-route-matcher-provider.js [app-rsc] (ecmascript)");
const _pagesapiroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/pages-api-route-matcher-provider.js [app-rsc] (ecmascript)");
const _pagesroutematcherprovider = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/pages-route-matcher-provider.js [app-rsc] (ecmascript)");
const _servermanifestloader = __turbopack_require__("[project]/node_modules/next/dist/server/route-matcher-providers/helpers/manifest-loaders/server-manifest-loader.js [app-rsc] (ecmascript)");
...
const _i18nprovider = __turbopack_require__("[project]/node_modules/next/dist/server/lib/i18n-provider.js [app-rsc] (ecmascript)");
const _sendresponse = __turbopack_require__("[project]/node_modules/next/dist/server/send-response.js [app-rsc] (ecmascript)");
const _utils3 = __turbopack_require__("[project]/node_modules/next/dist/server/web/utils.js [app-rsc] (ecmascript)");
const _constants2 = __turbopack_require__("[project]/node_modules/next/dist/lib/constants.js [app-rsc] (ecmascript)");
...
const _matchnextdatapathname = __turbopack_require__("[project]/node_modules/next/dist/server/lib/match-next-data-pathname.js [app-rsc] (ecmascript)");
...
const _decodepathparams = __turbopack_require__("[project]/node_modules/next/dist/server/lib/router-utils/decode-path-params.js [app-rsc] (ecmascript)");
const _rsc = __turbopack_require__("[project]/node_modules/next/dist/server/normalizers/request/rsc.js [app-rsc] (ecmascript)");
const _stripflightheaders = __turbopack_require__("[project]/node_modules/next/dist/server/app-render/strip-flight-headers.js [app-rsc] (ecmascript)");
...
const _serveractionrequestmeta = __turbopack_require__("[project]/node_modules/next/dist/server/lib/server-action-request-meta.js [app-rsc] (ecmascript)");
...
const _patchsetheader = __turbopack_require__("[project]/node_modules/next/dist/server/lib/patch-set-header.js [app-rsc] (ecmascript)");
...
const _adapter = __turbopack_require__("[project]/node_modules/next/dist/server/web/adapter.js [app-rsc] (ecmascript)");
const _utils4 = __turbopack_require__("[project]/node_modules/next/dist/server/instrumentation/utils.js [app-rsc] (ecmascript)");
...
const _utils5 = __turbopack_require__("[project]/node_modules/next/dist/server/response-cache/utils.js [app-rsc] (ecmascript)");
...
class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.dir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_require__("[externals]/path [external] (path, cjs)").resolve(dir);
        this.quiet = quiet;
        this.loadEnvConfig({
            dev
        });
        ...
        this.port = port;
        this.distDir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_require__("[externals]/path [external] (path, cjs)").join(this.dir, this.nextConfig.distDir);
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
        ...
        if (hasServerProps || isSSG || isAppPath) {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                const { tryGetPreviewData } = __turbopack_require__("[project]/node_modules/next/dist/server/api-utils/node/try-get-preview-data.js [app-rsc] (ecmascript)");
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    if ((0, _checks.isPagesRouteModule)(routeModule)) {
                        ...
                        try {
                            result = await routeModule.render(// @ts-expect-error - preexisting accepted this
                            request, response, {
                                page: pathname,
                                params: opts.params,
                                query,
        ...
        if (isPrefetchRSCRequest && typeof segmentPrefetchHeader === 'string') {
            var // of cacheEntry.value to CachedAppPageValue, because the outer
...
//# sourceMappingURL=node_modules_next_dist_server_base-server_82a3f1.js.map