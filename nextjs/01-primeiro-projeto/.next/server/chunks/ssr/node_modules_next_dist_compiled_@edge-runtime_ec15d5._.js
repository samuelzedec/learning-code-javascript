...
var import_web = __turbopack_require__("[externals]/stream/web [external] (stream/web, cjs)");
...
var require_util = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/core/util.js" (exports2, module2) {
        ...
        var { IncomingMessage } = __turbopack_require__("[externals]/http [external] (http, cjs)");
        ...
        var { Blob: Blob3 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
        var nodeUtil = __turbopack_require__("[externals]/util [external] (util, cjs)");
        var { stringify } = __turbopack_require__("[externals]/querystring [external] (querystring, cjs)");
        var { EventEmitter: EE } = __turbopack_require__("[externals]/events [external] (events, cjs)");
...
var require_diagnostics = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/core/diagnostics.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var diagnosticsChannel = __turbopack_require__("[externals]/diagnostics_channel [external] (diagnostics_channel, cjs)");
...
var require_dispatcher = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/dispatcher/dispatcher.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var EventEmitter = __turbopack_require__("[externals]/events [external] (events, cjs)");
...
var require_llhttp_wasm = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/llhttp/llhttp-wasm.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { Buffer: Buffer2 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
var require_webidl = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/webidl.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { types, inspect } = __turbopack_require__("[externals]/util [external] (util, cjs)");
        var { markAsUncloneable } = __turbopack_require__("[externals]/worker_threads [external] (worker_threads, cjs)");
...
var require_util2 = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/util.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { Transform } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
        var zlib = __turbopack_require__("[externals]/zlib [external] (zlib, cjs)");
        var { redirectStatusSet, referrerPolicySet: referrerPolicyTokens, badPortsSet } = require_constants3();
        var { getGlobalOrigin } = require_global();
        var { collectASequenceOfCodePoints, collectAnHTTPQuotedString, removeChars, parseMIMEType } = require_data_url();
        var { performance: performance2 } = __turbopack_require__("[externals]/perf_hooks [external] (perf_hooks, cjs)");
        var { isBlobLike, ReadableStreamFrom, isValidHTTPToken, normalizedMethodRecordsBase } = require_util();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { isUint8Array } = __turbopack_require__("[externals]/util/types [external] (util/types, cjs)");
...
var require_file = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/file.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { Blob: Blob3, File: File2 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
var require_formdata = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/formdata.js" (exports2, module2) {
        ...
        var { webidl } = require_webidl();
        var { File: NativeFile } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
        var nodeUtil = __turbopack_require__("[externals]/util [external] (util, cjs)");
...
var require_formdata_parser = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/formdata-parser.js" (exports2, module2) {
        ...
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { File: NodeFile } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
var require_body = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/body.js" (exports2, module2) {
        ...
        var { Blob: Blob3 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { isErrored, isDisturbed } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
        var { isArrayBuffer } = __turbopack_require__("[externals]/util/types [external] (util/types, cjs)");
...
var require_client_h2 = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/dispatcher/client-h2.js" (exports2, module2) {
        ...
        init_define_process();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { pipeline } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
        var util = require_util();
...
var require_proxy_agent = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/dispatcher/proxy-agent.js" (exports2, module2) {
        ...
        var { URL: URL2 } = __turbopack_require__("[externals]/url [external] (url, cjs)");
...
var require_readable = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/api/readable.js" (exports2, module2) {
        ...
        init_define_process();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { Readable } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
...
var require_api_request = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/api/api-request.js" (exports2, module2) {
        ...
        var { AsyncResource } = __turbopack_require__("[externals]/async_hooks [external] (async_hooks, cjs)");
...
var require_api_stream = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/api/api-stream.js" (exports2, module2) {
        ...
        init_define_process();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { finished, PassThrough } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
...
var require_api_pipeline = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/api/api-pipeline.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { Readable, Duplex, PassThrough } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
...
var require_mock_utils = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/mock/mock-utils.js" (exports2, module2) {
        ...
        var { STATUS_CODES } = __turbopack_require__("[externals]/http [external] (http, cjs)");
        var { types: { isPromise } } = __turbopack_require__("[externals]/util [external] (util, cjs)");
...
var require_mock_client = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/mock/mock-client.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { promisify } = __turbopack_require__("[externals]/util [external] (util, cjs)");
        var Client = require_client();
...
var require_pending_interceptors_formatter = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/mock/pending-interceptors-formatter.js" (exports2, module2) {
        ...
        init_define_process();
        var { Transform } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
        var { Console } = __turbopack_require__("[externals]/console [external] (console, cjs)");
...
var require_response = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/response.js" (exports2, module2) {
        ...
        var { kConstruct } = require_symbols();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { types } = __turbopack_require__("[externals]/util [external] (util, cjs)");
...
var require_request = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/request.js" (exports2, module2) {
        ...
        var { kConstruct } = require_symbols();
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
        var { getMaxListeners, setMaxListeners, getEventListeners, defaultMaxListeners } = __turbopack_require__("[externals]/events [external] (events, cjs)");
...
var require_fetch = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fetch/index.js" (exports2, module2) {
        ...
        var EE = __turbopack_require__("[externals]/events [external] (events, cjs)");
        var { Readable, pipeline, finished } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
...
var require_util4 = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/fileapi/util.js" (exports2, module2) {
        ...
        var { types } = __turbopack_require__("[externals]/util [external] (util, cjs)");
        var { StringDecoder } = __turbopack_require__("[externals]/string_decoder [external] (string_decoder, cjs)");
        var { btoa: btoa2 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
var require_events = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/websocket/events.js" (exports2, module2) {
        ...
        var { kEnumerableProperty } = require_util();
        var { kConstruct } = require_symbols();
        var { MessagePort } = __turbopack_require__("[externals]/worker_threads [external] (worker_threads, cjs)");
        var _eventInit;
...
var require_util7 = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/websocket/util.js" (exports2, module2) {
        ...
        var { isUtf8 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
var require_permessage_deflate = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/websocket/permessage-deflate.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { createInflateRaw, Z_DEFAULT_WINDOWBITS } = __turbopack_require__("[externals]/zlib [external] (zlib, cjs)");
...
var require_receiver = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/lib/web/websocket/receiver.js" (exports2, module2) {
        "use strict";
        init_define_process();
        var { Writable } = __turbopack_require__("[externals]/stream [external] (stream, cjs)");
        var assert = __turbopack_require__("[externals]/assert [external] (assert, cjs)");
...
var require_undici = __commonJS({
    "../../node_modules/.pnpm/undici@6.21.0/node_modules/undici/index.js" (exports2, module2) {
        ...
        module2.exports.File = globalThis.File ?? __turbopack_require__("[externals]/buffer [external] (buffer, cjs)").File;
...
var init_fetch = __esm({
    "src/primitives/fetch.js" () {
        "use strict";
        init_define_process();
        import_node_buffer = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
init_define_process();
var import_module = __toESM(__turbopack_require__("[externals]/module [external] (module, cjs)"));
function load(scopedContext = {}) {
    ...
    const consoleImpl = requireWithFakeGlobalScope({
        context,
        id: "console.js",
        sourceCode: __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/console.js.text.js [app-rsc] (ecmascript)"),
        scopedContext
    });
    Object.assign(context, {
    ...
    const timersImpl = requireWithFakeGlobalScope({
        context,
        id: "timers.js",
        sourceCode: __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/timers.js.text.js [app-rsc] (ecmascript)"),
        scopedContext
    });
    Object.assign(context, {
    ...
    const eventsImpl = requireWithFakeGlobalScope({
        context,
        id: "events.js",
        sourceCode: __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/events.js.text.js [app-rsc] (ecmascript)"),
        scopedContext
    });
    Object.assign(context, {
        Event,
    ...
    Object.assign(context, __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/stream.js [app-rsc] (ecmascript)"));
    const abortControllerImpl = requireWithFakeGlobalScope({
        context,
        id: "abort-controller.js",
        sourceCode: __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/abort-controller.js.text.js [app-rsc] (ecmascript)"),
        scopedContext: {
            ...scopedContext
        }
    });
    ...
    const urlImpl = requireWithFakeGlobalScope({
        context,
        id: "url.js",
        sourceCode: __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/url.js.text.js [app-rsc] (ecmascript)"),
        scopedContext: {
            ...scopedContext
        }
    });
...
function getCrypto(scopedContext) {
    if (typeof SubtleCrypto !== "undefined" || scopedContext.SubtleCrypto) {
        ...
        const webcrypto = __turbopack_require__("[externals]/crypto [external] (crypto, cjs)").webcrypto;
        return {
            crypto: webcrypto,
...
var import_load = __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/load.js [app-rsc] (ecmascript)");
...
var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
module.exports = typeof EdgeRuntime === 'string' ? edge() : __turbopack_require__("[project]/node_modules/next/dist/compiled/@edge-runtime/primitives/index.js [app-rsc] (ecmascript)");
function edge() {
    return {
        AbortController,
        AbortSignal,
...
//# sourceMappingURL=node_modules_next_dist_compiled_%40edge-runtime_ec15d5._.js.map