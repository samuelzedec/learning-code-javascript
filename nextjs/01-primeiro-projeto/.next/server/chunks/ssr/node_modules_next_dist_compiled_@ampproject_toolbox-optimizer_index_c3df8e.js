...
(()=>{
    var __webpack_modules__ = {
            ...
            class FileSystemCache {
                static create(e = {}) {
                    ...
                    try {
                        ...
                        l.debug("No filesystem access, falling back to in-memory cache only", e);
        ...
        2412: (e, t, r)=>{
            ...
            const { AMP_CACHE_HOST: a, AMP_RUNTIME_CSS_PATH: o, AMP_VALIDATION_RULES_URL: l, appendRuntimeVersion: c } = r(8846);
        ...
        8256: (e, t, r)=>{
            "use strict";
            const { move: i, insertText: n, appendChild: s, insertBefore: a, createDocType: o, createElement: l, firstChildByTag: c } = r(2547);
        ...
        4975: (e, t, r)=>{
            ...
            const l = "document.querySelector(\"script[src*='/v0.js']\").onerror=function(){" + "document.querySelector('style[amp-boilerplate]').textContent=''}";
            const c = "[].slice.call(document.querySelectorAll(" + "\"script[src*='/v0.js'],script[src*='/v0.mjs']\")).forEach(" + "function(s){s.onerror=" + "function(){" + "document.querySelector('style[amp-boilerplate]').textContent=''" + "}})";
        ...
        9464: (e, t, r)=>{
            ...
            const { parseLayout: o, cssLength: l, calculateHeight: c, calculateWidth: u, calculateLayout: d, getLayoutClass: f, isLayoutSizeDefined: p, getLayoutSizeDefinedClass: h } = r(4056);
            const m = [
                "",
                "nodisplay",
                "fixed",
            ...
            e.exports = {
                applyLayout: function(e, t) {
                    ...
                    const h = d(r, p, f, getAttributeOrNull(e, "sizes"), getAttributeOrNull(e, "heights"));
        ...
        9433: (e, t, r)=>{
            ...
            const { remove: s, insertAfter: a, createElement: o, firstChildByTag: l, nextNode: c } = r(2547);
            const u = "intrinsic";
            const d = 320;
            class Markdown {
                constructor(e){
        ...
        6037: (e, t, r)=>{
            "use strict";
            const { appendChild: i, createElement: n, hasAttribute: s, remove: a, insertAfter: o, nextNode: l, firstChildByTag: c } = r(2547);
            ...
            class OptimizeHeroImage {
                ...
                async transform(e, t) {
                    ...
                    let l = a.length;
                    if (l > r) {
                        this.log.warn(`Found ${l} hero elements on the page, but the maximum is set to ${r}. The limit can be configured via the 'maxHeroImage' parameter.`);
                        l = r;
                    }
                    const d = h(n);
                    for(let e = 0; e < l; e++){
                ...
                getPlaceholderImage(e) {
                    for (const t of e.children){
                        if (t.tagName === "amp-img" && s(t, "placeholder") && f(t.attribs.src)) {
                            return {
                                ampImg: t,
                                src: t.attribs.src,
        ...
        7185: (e, t, r)=>{
            "use strict";
            const { createElement: i, hasAttribute: n, firstChildByTag: s, insertAfter: a, insertBefore: o, remove: l } = r(2547);
            ...
            class RewriteAmpUrls {
                ...
                transform(e, t) {
                    ...
                    const m = [];
                    while(c){
                        if (c.tagName === "script" && this._usesAmpCacheUrl(c.attribs.src)) {
                        ...
                        } else if (c.tagName === "link" && c.attribs.rel === "stylesheet" && this._usesAmpCacheUrl(c.attribs.href)) {
                            c.attribs.href = this._replaceUrl(c.attribs.href, o);
                            if (h) {
                                m.push(this._createPreload(c.attribs.href, "style"));
                            }
                        } else if (c.tagName === "link" && c.attribs.rel === "preload" && this._usesAmpCacheUrl(c.attribs.href)) {
        ...
        4626: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, remove: n, createElement: s, insertBefore: a, nextNode: o, firstChildByTag: l } = r(2547);
            const { skipNodeAndChildren: c } = r(7041);
        ...
        4404: function(e, t, r) {
            ...
            function formatAttributes(e, t) {
                ...
                return Object.keys(e).map(function(r) {
                    ...
                    if (t.xmlMode === "foreign") {
                        r = (n = c.attributeNames.get(r)) !== null && n !== void 0 ? n : r;
                    }
                    if (!t.emptyAttrs && !t.xmlMode && s === "") {
                        return r;
                    }
                    return r + '="' + (t.decodeEntities ? l.encodeXML(s) : s.replace(/"/g, "&quot;")) + '"';
                }).join(" ");
            }
            var d = new Set([
                "area",
            ...
            function renderTag(e, t) {
                ...
                if (e.children.length === 0 && (t.xmlMode ? t.selfClosingTags !== false : t.selfClosingTags && d.has(e.name))) {
                    if (!t.xmlMode) n += " ";
                    n += "/>";
                } else {
                    n += ">";
        ...
        6032: function(e, t, r) {
            ...
            function escape(e) {
                return e.replace(f, singleCharReplacer).replace(d, astralReplacer).replace(u, singleCharReplacer);
            }
            t.escape = escape;
        },
        9280: (e, t, r)=>{
        ...
        8937: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/cssnano-simple/index.js [app-rsc] (ecmascript)");
        },
        7330: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/lru-cache/index.js [app-rsc] (ecmascript)");
        },
        4429: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/node-fetch/index.js [app-rsc] (ecmascript)");
        },
        7595: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/postcss-safe-parser/safe-parse.js [app-rsc] (ecmascript)");
        },
        6794: (e)=>{
            "use strict";
            e.exports = __turbopack_require__("[project]/node_modules/next/dist/compiled/terser/bundle.min.js [app-rsc] (ecmascript)");
        },
        2037: (e)=>{
            "use strict";
...
//# sourceMappingURL=node_modules_next_dist_compiled_%40ampproject_toolbox-optimizer_index_c3df8e.js.map