...
// Saída: '1º Nível'
console.log(arr[1])       
// Saída: [ '2º nível', 42, true ]
console.log(arr[1][0])    
// Saída: '2º nível'
console.log(arr[1][1])    
// Saída: 42
console.log(arr[2])       
// Saída: [ [ '3º nível, 1º item', 'Olá, mundo!' ], [ '3º nível, 2º item', 'Oi, mundo!' ] ]
console.log(arr[2][0])    
// Saída: [ '3º nível, 1º item', 'Olá, mundo!' ]
...
const matriz = [
  ...
  //Como passar por cada elemento da matriz
  let elementos = ''
  for(let i = 0; i < matriz.length; i++) {
    for(let j = 0; j < matriz[i].length; j++) {
        elementos = `O elemento ${matriz[i][j]} está na linha ${i} e na coluna ${j}`
